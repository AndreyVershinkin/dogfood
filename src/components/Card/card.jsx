...
const Card = ({ name, price, discount, wight, description, picture }) => {
	...
	return (
		<div className='card'>
			<div className="card__sticky card__stiicky-type-top-left">
				{discount !== 0 && <span className="card__discount">{`-${discount}%`}</span>}
			</div>
			<div className="card__sticky card__sticky-type-top-right">
			...
			<a href="/product" className="card__link">
				...
				<div className="card__desc">
					...
					{discount !== 0 && <span className="card__price card__price-type-discount">
						{discount_price}&nbsp;₽
					</span>}
			...
			<a href="#" className="card__cart btn btn-type-primary">
				В корзину
			</a>
		</div>
